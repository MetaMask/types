...
import type { EthEncryptedData } from 'eth-sig-util';

import { Json } from './json';
import { HexPrefixed } from './hex-prefixed';
 ...
 */
export interface Keyring<State extends Json> {
  /**
   ...
   */
  getAccounts(): Promise<HexPrefixed[]>;
   ...
   */
  addAccounts(number: number): Promise<HexPrefixed[]>;
   ...
   */
  removeAccount?(address: HexPrefixed): void;
   ...
   */
  getAppKeyAddress?(address: HexPrefixed, origin: string): Promise<HexPrefixed>;
